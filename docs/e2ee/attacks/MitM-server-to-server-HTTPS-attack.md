...
* [DNS cache poisoning](https://tymyrddin.github.io/attack-trees/docs/network/DNS-attacks.html) can be used to replace the real endpoint with an attacker's replacement using a self-signed certificate.
